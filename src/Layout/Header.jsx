            ...
            isPathInHome && <div className="limited" style={{display: showLimited ? 'flex' : 'none'}}>
                <div className='limitedFixed'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="10" height="10"
                         fill='white'
                         onClick={() => setshowLimited(false)} cursor='pointer'>
                        <path
        ...
        <div className="content">
            <div className="topsec">
                ...
                <div className="profile-sec">
                    {isPathRegister ? <img src={user} alt=""/> :
                    ...
                    <img src={favs} alt=""/>
                    {isPathInHome ? <img src={shopping} alt=""/> :
                        <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="18" height="18">
                            <path
                    ...
                    <div className="mega-menu expandable">
                        <div className="mega-menu-content" style={{marginTop: isPathInHome && showLimited && '29px'}}>
                            <div className="triangle-container"
                                 style={{marginBottom: isPathInHome && showLimited && '25px'}}>
                                <ul>
                                    <li>
