                ...
                <Grid item lg={1} sx={{ display: { xs:"none", lg: "block" }}}>
                    ...
                    <Grid item sm={6} lg={4} sx={{paddingLeft: "20px"}}>
                        <div className={classes.topCard}>
                            ...
                            <p className={classes.price}>{TshirtsData[0].discount ==! "0" ? <strong>{TshirtsData[0].price}</strong> :                                <span><strong>{TshirtsData[0].discount}</strong> <strike>{TshirtsData[0].price}</strike>
                        ...
                        <div className={classes.sizeContainer}>
                            ...
                            <div className={classes.questionContainer}>
                                ...
                                <Collapse orientation="horizontal" in={plus1}>
                                    <p>See how this cotton jersey crewneck T-shirt gets shaken up. The garment features the iconic Skull with Brand and rhinestone applications. A saffian leather patch bearing the PP Hexagon is sewn on the yoke. Two needle stitching hems.</p>
                                </Collapse>
                            </div>
                        <div className={classes.questionContainer}>
                        ...
                        <div className={classes.questionContainer}>
                            ...
                            <Collapse orientation="horizontal" in={plus3}>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem cupiditate doloribus eum facere hic ipsum laudantium placeat, quam quia quisquam quo quod reprehenderit suscipit. Atque corporis magnam nobis porro praesentium?</p>
                            </Collapse>
                        </div>
                        <div className={classes.questionContainer}>
