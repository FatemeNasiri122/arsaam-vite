                            ...
                            <Grid container columnSpacing={2} rowSpacing={0.7}>
                                ...
                                <Grid item xs={12}>
                                    <div className={classes.checkContainer}>
                                        <div className={classes.box} onClick={() => setChecked(!checked)}>
                                            <div style={checked ? {display: "flex"} : {display: "none"}}
                                                 className={classes.checkBox}></div>
                                        </div>

                                        <p onClick={() => setChecked(!checked)}>I would like to receive a newsletter</p>
                                    </div>
                                </Grid>
                                <Grid item xs={12} sm={3}>
                                    <LinkButton isOnClicked={true} width='100%' height='40px' color='#fff'
                                                background='#000' linkText="SAVE DATA" marginTop='25px'
                                                marginButtom='10px'/>
                                </Grid>
                            </Grid>
                        </form>
