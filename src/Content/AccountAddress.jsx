                ...
                <Grid item xs={12} md={8} display={isMobileActive && {xs: 'none',md: 'block'}} paddingLeft={{md: '20px'}} marginTop={'18px'}>
                    ...
                    <div className={classes.container}>
                        <div className={classes.addressTitle}>
                            <h2>ADDRESSES</h2>   <a className={classes.notActive} href=""><svg className={classes.notActiveIcon} xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="14" height="14"><path d="M23,11H13V1a1,1,0,0,0-1-1h0a1,1,0,0,0-1,1V11H1a1,1,0,0,0-1,1H0a1,1,0,0,0,1,1H11V23a1,1,0,0,0,1,1h0a1,1,0,0,0,1-1V13H23a1,1,0,0,0,1-1h0A1,1,0,0,0,23,11Z"/></svg>
                            ADD NEW ADDRESS</a>
                        </div>
                        <Grid container>
