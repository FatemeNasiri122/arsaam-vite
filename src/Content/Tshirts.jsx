        ...
        <div className={containerClass.container}>
            ...
            <div className={classes.category}>
                ...
                <div className={classes.selectsContainer}>
                    ...
                    <div className={classes.selectContainer}>
                        <div className={classes.select} onClick={() => setChecked((prev) => !prev)}><span>color</span>
                            <FiChevronDown style={checked ? {transform: 'rotate(180deg)'} : {transform: 'rotate(0deg)'}}
            ...
            <div className={classes.clear}>
                <div>
                    <IconButton aria-label="delete"
                                sx={{color: '#808080', font: 'normal normal normal 12px/15px Century Gothic;'}}>
