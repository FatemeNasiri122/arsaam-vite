...
export default function FavoriteItem({data}) {
    ...
    return (
        <Grid container sx={{borderTop: '1px solid #BFBFBF', borderBottom: '1px solid #D9D9D9', padding: '21px 0px'}}>
            <Grid item xs={4} sm={2} marginRight={{sm: '30px'}}
                  display={{xs: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center'}}>
            ...
            <Grid item xs={12} sm={1} display={{sm: 'flex', alignItems: 'center', xs: 'flex', justifyContent: 'center'}}
                  paddingTop={1}>
                <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="24"
